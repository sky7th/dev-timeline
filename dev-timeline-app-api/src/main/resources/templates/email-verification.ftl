                                ...
                                <table style="background: #336f85; border: 0px; border-radius: 0px; width: 599px; height: 53px; margin-left: auto; margin-right: auto;"
                                    ...
                                    <tr>
                                        ...
                                        <td class="tw-card-header"
                                            ...
                                            align="center"><span
                                                style="font-weight: 600;">이메일 인증 요청</span></td>
                                    ...
                                    <tr>
                                        <td class="tw-card-body"
                                            ...
                                            <h1 class="tw-h1"
                                                ...
                                                안녕하세요, dev-time 입니다.</h1>
                                            <p class=""
                                               style="margin: 20px 0; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">
                                            <span style="font-weight: 400;">저희 <strong>dev-time</strong>에 가입해주셔서 감사합니다!</span><br/><br/><span
                                                style="font-weight: 400;">가입 절차를 완료하려면 이메일 주소(${userName})를 확인하시고 아래 버튼을 눌러서 계정을 활성화하세요.</span>
                                                            ...
                                                            <tr>
                                                                <td class="button__td "
                                                                    ...
                                                                    <![endif]--> <!-- [if !mso]><!--> <a
                                                                            ...
                                                                            target="_blank"
                                                                            rel="noopener">이메일 인증</a> <!--![endif]--></td>
                                                            </tr>
                                                            </tbody>
                                                        </table>
                                                    </td>
                                            ...
                                            <p class="tw-signoff"
                                               style="margin: 45px 0 5px; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">dev-time</p>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
