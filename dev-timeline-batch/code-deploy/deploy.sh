ORIGIN_JAR_PATH='/home/jenkins/dev-timeline-batch/deploy/*.jar'
ORIGIN_JAR_NAME=$(basename ${ORIGIN_JAR_PATH})
TARGET_PATH='/home/jenkins/dev-timeline-batch/application.jar'
JAR_BOX_PATH='/home/jenkins/dev-timeline-batch/jar/'
