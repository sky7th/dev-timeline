...
public class CommentController {
    ...
    public ResponseEntity<Object> save(@PathVariable Long postId, @RequestBody CommentRequestDto requestDto,
            UserContext userContext) {
        return ResponseEntity.ok(commentService.save(postId, requestDto, userContext));
    }

    @PutMapping("/api/v1/comment/{commentId}")
    public ResponseEntity<Object> update(@PathVariable Long commentId, @RequestBody CommentUpdateRequestDto requestDto,
            UserContext userContext) {
